...
Open terminal in the folder `sf2_loader(linux compatible)`, firstly run `pip install midiutil`, and then run `sudo python setup.py install` to install this package. (some of the codes are changed for Linux compatible versions of this pakcage for compatibility, so you cannot use pip to install this package, because that will install the version for Windows)
...
Open terminal in the folder `sf2_loader(macOS compatible)`, firstly run `pip install midiutil`, and then run `python setup.py install` to install this package. (some of the codes are changed for macOS compatible versions of this pakcage for compatibility, so you cannot use pip to install this package, because that will install the version for Windows)
